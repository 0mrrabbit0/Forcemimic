...
def main(args):
    ...
    for stage_name in tqdm.tqdm(data_dict.keys()):
        with h5py.File(os.path.join(save_path, stage_name + '.hdf5'), 'w') as stage_hdf5:
            ...
            stage_hdf5_o_group.create_dataset('d415_pc_xyzs_d415', data=np.array(data_dict[stage_name]['d415_pc_xyzs_d415']))
            stage_hdf5_o_group.create_dataset('d415_pc_rgbs', data=np.array(data_dict[stage_name]['d415_pc_rgbs']))
            stage_hdf5_o_group.create_dataset('d415_pc_xyzs_d415_mesh', data=np.array(data_dict[stage_name]['d415_pc_xyzs_d415_mesh']))
            stage_hdf5_o_group.create_dataset('d415_pc_rgbs_mesh', data=np.array(data_dict[stage_name]['d415_pc_rgbs_mesh']))
